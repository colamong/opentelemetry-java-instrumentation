...
readonly INSTRUMENTATIONS=(
  ...
  "aws-lambda:aws-lambda-events-2.2:javaagent:testBothSemconv"
  "aws-lambda:aws-lambda-events-2.2:javaagent:testMessagingPreview"
  "aws-lambda:aws-lambda-events-2.2:javaagent:testV3Preview"
  "aws-lambda:aws-lambda-events-3.11:library:test"
  "aws-lambda:aws-lambda-events-3.11:library:testBothSemconv"
  "aws-lambda:aws-lambda-events-3.11:library:testMessagingPreview"
  "aws-lambda:aws-lambda-events-3.11:library:testV3Preview"
  "aws-sdk:aws-sdk-1.11:javaagent:test"
  "aws-sdk:aws-sdk-1.11:javaagent:testMessagingPreview"
  ...
  "aws-sdk:aws-sdk-2.2:javaagent:testMessagingPreview"
  ...
  "kafka:kafka-clients:kafka-clients-2.6:library:testMessagingPreview"
  "kafka:kafka-connect-2.6:testing:test"
  "kafka:kafka-connect-2.6:testing:testMessagingPreview"
  ...
  "pulsar:pulsar-2.8:javaagent:testMessagingPreview"
  ...
  "rabbitmq-2.7:javaagent:testMessagingPreview"
  ...
  "reactor:reactor-kafka-1.0:javaagent:testMessagingPreview"
  ...
  "rocketmq:rocketmq-client-4.8:javaagent:testMessagingPreview"
  "rocketmq:rocketmq-client-5.0:javaagent:test"
  "rocketmq:rocketmq-client-5.0:javaagent:testMessagingPreview"
  ...
  "spring:spring-pulsar-1.0:javaagent:testMessagingPreview"
  "spring:spring-rabbit-1.0:javaagent:test"
  "spring:spring-rabbit-1.0:javaagent:testMessagingPreview"
  ...
  "vertx:vertx-kafka-client-3.6:vertx-kafka-client-3.6-testing:testMessagingPreview"
